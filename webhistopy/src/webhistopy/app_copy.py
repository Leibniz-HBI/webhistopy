...
class WebhistoPy(toga.App):
    ...
    def create_networks(self,button):
        ...
        #nx.draw_networkx(domain_net)
        #f"~/Desktop/{self.pseudonym.value}_web_histopy_history.csv"
        #print(domain_net)
        #domain_net.show(str(Path(home).joinpath("Desktop","web_history_graph.html")))
        domain_net.show('~\Documents\GitHub\webhistopy\webhistopy\src\webhistopy\graph.html')
